...
const AppContent: React.FC = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/sell" element={<RequireAuth><AppLayout><SellScreen /></AppLayout></RequireAuth>} />
      <Route path="/stock" element={<RequireAuth><AppLayout><StockScreen /></AppLayout></RequireAuth>} />
      <Route path="/report" element={<RequireAuth><AppLayout><ReportScreen /></AppLayout></RequireAuth>} />
      <Route path="/settings" element={<RequireAuth><AppLayout><SettingsScreen /></AppLayout></RequireAuth>} />

  ...
  return (
    <div className="fixed inset-0 z-[150] bg-black flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center relative">
        <div id="qr-reader" className="w-full max-w-sm" ref={containerRef} />
      ...
      <div className="bg-black/80 px-4 py-4 text-center">
        <p className="text-gray-400 text-sm">Elekeza kamera kwenye QR code au barcode ya bidhaa</p>
        <p className="text-gray-600 text-xs mt-1">Kamera ya nyuma inatumika kwa usahihi zaidi</p>
      </div>
    </div>
  )
}
